...
# UsoCaso: TriarEditalUseCase, SolicitarTriagemUseCase (docs/14 §3)
# Bloqueado: modules/triagem não implementado — aguardando RAD-30 (Iara)
# Quando RAD-30 chegar: remover @pending e importar use cases em triagem.steps.ts
